...
export const App = () => {
  ...
  const submit = () => {
    ...
    window.gtag('event', '6181_add_bot', { bot: selectedRobot?.robot_info.name || '', var: 'var4' });
        ...
        <div className={appSt.container}>
          ...
          <div className={appSt.box2} style={{ flexDirection: 'column' }}>
            ...
            <ButtonMobile
              ...
              size={32}
              onClick={() => {
                window.gtag('event', '6181_consult_bot', { bot: selectedRobot.robot_info.name, var: 'var4' });
              }}
            >
      ...
      <div className={appSt.container}>
        ...
        {robots.map((robot, index) => (
          <div
            ...
            key={robot.id}
            onClick={() => {
              window.gtag('event', '6181_card_bot', { bot: robot.robot_info.name, var: 'var4' });
